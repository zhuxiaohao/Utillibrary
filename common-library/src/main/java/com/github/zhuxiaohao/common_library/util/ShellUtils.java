...
public class ShellUtils {
     ...
     * @see ShellUtils#execCommand(String[], boolean, boolean)
     */
    public static CommandResult execCommand(java.util.List<String> commands, boolean isRoot) {
     ...
     * @see ShellUtils#execCommand(String[], boolean, boolean)
     */
    public static CommandResult execCommand(java.util.List<String> commands, boolean isRoot, boolean isNeedResultMsg) {
