...
import com.github.zhuxiaohao.common_library.util.TimeUtils;
...
public class HttpCacheDaoImpl implements HttpCacheDao {
    ...
    public HttpResponse getHttpResponse(String url) {
        ...
        synchronized (HttpCacheDaoImpl.class) {
            android.database.Cursor cursor = sqliteUtils.getDb().query(DbConstants.HTTP_CACHE_TABLE_TABLE_NAME, null, appWhere.toString(), appWhereArgs, null, null, null);
            if (cursor == null) {
                return null;
            }
    ...
    public Map<String, HttpResponse> getHttpResponsesByType(int type) {
        ...
        synchronized (HttpCacheDaoImpl.class) {
            android.database.Cursor cursor = sqliteUtils.getDb().query(DbConstants.HTTP_CACHE_TABLE_TABLE_NAME, null, whereClause.toString(), whereClauseArgs, null, null, null);
