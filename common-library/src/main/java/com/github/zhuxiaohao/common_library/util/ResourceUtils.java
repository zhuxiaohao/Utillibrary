...
public class ResourceUtils {
	 ...
	 * @return
	 */
	public static java.util.List<String> geFileToListFromAssets(Context context, String fileName) {
		if (context == null || StringUtils.isEmpty(fileName)) {
			return null;
		}
	 ...
	 * @return
	 */
	public static java.util.List<String> geFileToListFromRaw(Context context, int resId) {
		if (context == null) {
			return null;
		}
