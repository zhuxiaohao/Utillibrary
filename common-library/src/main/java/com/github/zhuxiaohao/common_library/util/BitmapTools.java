...
public class BitmapTools {
	 ...
	 * @throws IOException
	 */
	public static void saveBitmap(String path, android.graphics.Bitmap bitmap) throws IOException {
	 ...
	 * @return
	 */
	public static synchronized void loadImage(String folder, String url, BitmapTools.LoadingListener listener) {
		try {
			// 注意url可能包含?的情况，需要在?前截断
			if (url.indexOf("?") > 0) {
				url = url.substring(0, url.indexOf("?"));
