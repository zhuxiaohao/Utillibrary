...
public class CacheObject<V> implements java.io.Serializable, Comparable<CacheObject<V>> {
    ...
    public boolean equals(Object o) {
        ...
        return (ObjectUtils.isEquals(this.data, obj.data) && this.enterTime == obj.enterTime && this.priority == obj.priority && this.isExpired == obj.isExpired && this.isForever == obj.isForever);
    }
