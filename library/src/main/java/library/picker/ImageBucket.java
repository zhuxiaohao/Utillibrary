...
public class ImageBucket implements Parcelable {
    ...
    public java.util.ArrayList<ImageItem> bucketList;
    ...
    protected ImageBucket(Parcel in) {
        ...
        this.bucketList = in.createTypedArrayList(library.picker.ImageItem.CREATOR);
    }
    ...
    public java.util.List<ImageItem> getBucketList() {
        return bucketList;
    }

    public void setBucketList(java.util.ArrayList<ImageItem> bucketList) {
