 ...
 * date: 2014年11月20日 下午6:17:15 <br/>
 * 对象缓存
 * @author chenhao
 * @version @param <V>
 * @since JDK 1.6
 */
public class CacheObject<V> implements java.io.Serializable, Comparable<CacheObject<V>> {
     ...
     */
    @Override
    public int compareTo(library.entity.CacheObject<V> o) {
        return o == null ? 1 : library.util.ObjectUtils.compare(this.data, o.data);
    }
    ...
    public boolean equals(Object o) {
        ...
        library.entity.CacheObject<V> obj = (library.entity.CacheObject<V>) (o);
        return (library.util.ObjectUtils.isEquals(this.data, obj.data) && this.enterTime == obj.enterTime && this.priority == obj.priority && this.isExpired == obj.isExpired && this.isForever == obj.isForever);
    }
