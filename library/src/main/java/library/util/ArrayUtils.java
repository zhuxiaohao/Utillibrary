 ...
 * date: 2014年11月20日 下午5:01:31 <br/>
 * 数组工具类，可用于数组常用操作，
 * 如： isEmpty(V[] sourceArray) 判断数组是否为空或长度为0 
 * getLast(V[]sourceArray, V value, V defaultValue, boolean isCircle)
 * 得到数组中某个元素前一个元素，isCircle表示是否循环 getNext(V[] sourceArray, V value, V defaultValue, boolean isCircle) 
