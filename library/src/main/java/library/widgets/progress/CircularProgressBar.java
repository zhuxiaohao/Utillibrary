...
package library.widgets.progress;
...
/**
 * Project Name:com.cn.reading.api
 * File Name: Reading
 * Date:15/8/28下午4:1808
...
public class CircularProgressBar extends ProgressBar {
  ...
  public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (isInEditMode()) {
      setIndeterminateDrawable(new library.widgets.progress.CircularProgressDrawable.Builder(context, true).build());
      return;
    }
